...
import { ArrowLeft, Download, ExternalLink, Cpu, Construction, Monitor, Youtube, Play } from "lucide-react";
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-10 items-center md:items-start text-center md:text-left">
                        ...
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-2">
                                <a href="https://ppsspp.org/download" target="_blank" className="bg-cyan-600 hover:bg-cyan-500 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg shadow-cyan-900/20 flex items-center gap-2">
                                    <Download className="w-5 h-5" />
                                    Download .DMG
                                </a>
                                <a href="https://ppsspp.org" target="_blank" className="bg-zinc-800 hover:bg-zinc-700 text-zinc-200 px-6 py-3 rounded-xl font-medium transition-all border border-zinc-700 flex items-center gap-2">
