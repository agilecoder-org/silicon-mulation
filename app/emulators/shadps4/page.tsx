...
import { ExternalLink, Download, AlertTriangle, Cpu, Settings, Skull, Youtube, Play, Construction } from "lucide-react";
    ...
    return (
        <div className="min-h-screen pt-32 pb-20 px-6">
            <div className="max-w-6xl mx-auto">
                <BackButton href="/emulation" label="Back to Emulation" />
                    ...
                    <div className="relative z-10 flex flex-col md:flex-row gap-10 items-start text-left">
                        ...
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="flex flex-wrap items-center justify-start gap-4 pt-2">
                                <a href="https://github.com/shadps4-emu/shadPS4/releases" target="_blank" className="w-full sm:w-auto justify-center bg-red-700 hover:bg-red-600 text-white px-6 py-3 rounded-xl font-bold transition-all shadow-lg shadow-red-900/20 flex items-center gap-2">
                                    <Download className="w-5 h-5" />
                                    Download Pre-release
                                </a>
                                <a href="https://github.com/shadps4-emu/shadPS4" target="_blank" className="w-full sm:w-auto justify-center bg-zinc-800 hover:bg-zinc-700 text-zinc-200 px-6 py-3 rounded-xl font-medium transition-all border border-zinc-700 flex items-center gap-2">
